...
const OsesChart = () => {
  ...
  const { data, error } = useSWR(["/api/metrics/views/oses", timeRange], (url, range) =>
    fetcher(url, { range })
  );
      ...
      <div className="bg-white px-4 py-5 sm:px-6">
        <div className="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
          <div className="ml-4 mt-4">
            <h3 className="text-lg leading-6 font-medium text-gray-900">OS Chart</h3>
