...
// Cross-module on purpose: formatDateRange takes a zone, so the expected
// boundaries have to come from the module that defines what a zoned day is.
import {
  endOfZonedDayExclusive,
  startOfZonedDay,
} from "~/modules/analytics/timezone";
